...
- [Build Charter](../build-charter.md): Our core principles for the build process.
- [Open Source Standards](../oss-standards.md): Information about our standards.
- [Maven Profiles](../maven-profiles.md): Capability profiles for developer builds.
